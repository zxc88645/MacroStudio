...
public class StartupXamlGuardTests
{
    ...
    {
        var xaml = ReadRepoFile(@"src\MacroStudio.Presentation\MainWindow.xaml");
    ...
    public void Views_ShouldNotUseDynamicResourceAsBindingConverter()
    {
        var paths = new[]
        {
            @"src\MacroStudio.Presentation\Views\ScriptListView.xaml",
            @"src\MacroStudio.Presentation\Views\CommandGridView.xaml",
            @"src\MacroStudio.Presentation\Views\CountdownWindow.xaml",
            @"src\MacroStudio.Presentation\Views\InputDialog.xaml",
            @"src\MacroStudio.Presentation\Views\PickPointWindow.xaml",
        };
    ...
    private static string FindRepoRoot()
    {
        ...
        while (dir != null)
        {
            if (File.Exists(Path.Combine(dir.FullName, "tasks.md")) &&
                File.Exists(Path.Combine(dir.FullName, "MacroStudio.slnx")))
            {
                return dir.FullName;
            }
            dir = dir.Parent;
