...
This directory contains the domain service interfaces that define the contracts for the core business operations of the Macro Studio application. These interfaces follow the hexagonal architecture pattern, keeping the domain layer independent of infrastructure concerns.
