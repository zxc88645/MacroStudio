...
public class JsonFileStorageService : IFileStorageService
{
    ...
    /// Optional base directory for storage (primarily for tests). If null, defaults to LocalApplicationData\\MacroNex.
    /// </param>
    public JsonFileStorageService(ILogger<JsonFileStorageService> logger, string? storageDirectory = null)
    {
        ...
        if (string.IsNullOrWhiteSpace(storageDirectory))
        {
            ...
            _storageDirectory = Path.Combine(appDataPath, "MacroNex");
        }
        else
        {
