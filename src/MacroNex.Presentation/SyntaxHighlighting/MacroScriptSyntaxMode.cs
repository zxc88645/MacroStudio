...
namespace MacroNex.Presentation.SyntaxHighlighting;

/// <summary>
/// Provides syntax highlighting for MacroNex script DSL.
/// </summary>
public static class MacroScriptSyntaxMode
{
    ...
    /// <summary>
    /// Gets the highlighting definition for MacroNex scripts.
    /// </summary>
